...
class MyAddressesViewModel {
    ...
    init() {
        ...
        func deleteAddress(_ address: Address) {
            ...
            let baseURLString = "https://ios-q1-new-capital-2023.myshopify.com/admin/api/2023-10/customers/\(customerID)/addresses/\(address.id ?? 0).json"
            let headers: HTTPHeaders = ["X-Shopify-Access-Token": "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"]
        ...
        func setDefaultAddressForCustomer(_ address: Address, index: Int) {
            ...
            let baseURLString = "https://ios-q1-new-capital-2023.myshopify.com/admin/api/2023-10/customers/\(customerID)/addresses/\(address.id ?? 0)/default.json"
            let headers: HTTPHeaders = ["X-Shopify-Access-Token": "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"]
